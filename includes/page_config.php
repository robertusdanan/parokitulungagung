...
// Defensive load helper ikon (iconUrl) kalau parent belum memuatnya.
...
$pageConfig = [
    'agenda' => [
        ...
        'icon'             => iconUrl('icon_square_agenda.png'),
    ...
    'galeri' => [
        ...
        'icon'             => iconUrl('icon_square_foto.png'),
    ...
    'petugas' => [
        ...
        'icon'             => iconUrl('icon_square_petugas.png'),
    ...
    'profil_lingkungan' => [
        'title'            => 'Wilayah',
        'menuTitle'        => 'Wilayah',
        'icon'             => iconUrl('icon_square_lingkungan.png'),
    ...
    'profil_ai' => [
        ...
        'icon'             => iconUrl('icon_square_ai.png'),
    ...
    'profil_dpp' => [
        'title'            => 'DPP & BGKP',
        'menuTitle'        => 'DPP & BGKP',
        'icon'             => iconUrl('icon_square_dpp.png'),
    ...
    'kategorial' => [
        ...
        'icon'             => iconUrl('icon_square_kategorial3.png'),
