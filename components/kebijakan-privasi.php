...
$seo = [
    'title'       => 'Kebijakan Privasi – Paroki Tulungagung',
    'description' => 'Kebijakan Privasi website resmi Gereja Katolik Santa Maria Dengan Tidak Bernoda Asal (SMDTBA) Tulungagung.',
    'canonical'   => 'https://www.parokitulungagung.org/kebijakan-privasi',
    'keywords'    => 'kebijakan privasi, paroki smdtba, tulungagung',
];
$breadcrumbs = [
...
<body>
<?php $headerTitle = 'Kebijakan Privasi'; include __DIR__ . '/page_header.php'; ?>
  <main>
    <div class="pol-hero">
      <div class="pol-hero-inner">
        <svg class="pol-hero-cross" viewBox="0 0 48 64" fill="none"><rect x="20" y="0" width="8" height="64" rx="2" fill="#d4af6a"/><rect x="0" y="18" width="48" height="8" rx="2" fill="#d4af6a"/></svg>
        <div class="pol-hero-eyebrow">Paroki Tulungagung</div>
        <h1>Kebijakan Privasi</h1>
        <p class="pol-hero-sub">Terakhir diperbarui: Maret 2026</p>
      </div>
    </div>
    <div class="pol-layout">
      <nav class="pol-toc" aria-label="Daftar Isi">
        ...
        <ol>
          ...
          <li><a href="#data-dikumpulkan">Data yang Dikumpulkan</a></li>
          <li><a href="#tujuan-penggunaan">Tujuan Penggunaan Data</a></li>
          <li><a href="#cookies">Cookies &amp; Teknologi Serupa</a></li>
          <li><a href="#pihak-ketiga">Layanan Pihak Ketiga</a></li>
          <li><a href="#hak-pengguna">Hak Pengguna</a></li>
          <li><a href="#keamanan">Keamanan Data</a></li>
          <li><a href="#kontak">Hubungi Kami</a></li>
        </ol>
      </nav>
      <section class="pol-section" id="pengantar">
        <div class="pol-section-header"><span class="pol-section-num">I</span><h2>Pengantar</h2></div>
        <hr class="pol-divider">
        <p>Selamat datang di website resmi <strong>Paroki Santa Maria Dengan Tidak Bernoda Asal (SMDTBA) Tulungagung</strong>, yang dapat diakses melalui <em>parokitulungagung.org</em>.</p>
        <p>Kami berkomitmen untuk melindungi privasi setiap pengunjung. Kebijakan ini menjelaskan secara transparan jenis data yang kami kumpulkan, bagaimana data digunakan, serta hak-hak Anda atas informasi pribadi Anda.</p>
        <p>Dengan mengakses website ini, Anda menyatakan telah membaca dan memahami kebijakan yang kami uraikan di sini.</p>
      </section>
      <section class="pol-section" id="data-dikumpulkan">
        <div class="pol-section-header"><span class="pol-section-num">II</span><h2>Data yang Dikumpulkan</h2></div>
        <hr class="pol-divider">
        <p>Website ini bersifat informatif dan <strong>tidak memiliki formulir registrasi atau login</strong>. Namun, beberapa data dapat dikumpulkan secara otomatis, meliputi:</p>
        <ul>
          <li><strong>Data teknis:</strong> alamat IP, jenis perangkat, browser, sistem operasi, serta waktu kunjungan.</li>
          <li><strong>Data navigasi:</strong> halaman yang dikunjungi, durasi kunjungan, halaman asal, dan tautan yang diklik.</li>
          <li><strong>Data cookies:</strong> informasi sesi kunjungan yang disimpan sementara di perangkat Anda.</li>
        </ul>
        <div class="pol-highlight"><strong>Catatan penting:</strong> Kami tidak mengumpulkan nama, nomor telepon, alamat surel, atau informasi pribadi identifikatif lainnya secara langsung, kecuali apabila Anda secara sukarela menghubungi kami.</div>
      </section>
      <section class="pol-section" id="tujuan-penggunaan">
        <div class="pol-section-header"><span class="pol-section-num">III</span><h2>Tujuan Penggunaan Data</h2></div>
        <hr class="pol-divider">
        <p>Data yang dikumpulkan digunakan semata-mata untuk:</p>
        <ul>
          <li>Memastikan website berfungsi dengan baik dan dapat diakses pengunjung.</li>
          <li>Menganalisis statistik kunjungan untuk meningkatkan kualitas konten.</li>
          <li>Mendeteksi dan mencegah potensi masalah keamanan.</li>
          <li>Memenuhi kewajiban teknis pengelolaan server dan hosting.</li>
        </ul>
        <p>Kami <strong>tidak menggunakan data Anda untuk kepentingan komersial, pemasaran langsung, atau profilisasi pengguna.</strong></p>
      </section>
      <section class="pol-section" id="cookies">
        <div class="pol-section-header"><span class="pol-section-num">IV</span><h2>Cookies &amp; Teknologi Serupa</h2></div>
        <hr class="pol-divider">
        <p>Website ini dapat menggunakan <em>cookies</em> — berkas data kecil yang disimpan di perangkat Anda. Jenis cookies yang mungkin digunakan:</p>
        <ul>
          <li><strong>Cookies sesi:</strong> bersifat sementara dan dihapus otomatis saat browser ditutup.</li>
          <li><strong>Cookies analitik:</strong> digunakan oleh Google Analytics untuk memahami pola kunjungan secara agregat dan anonim.</li>
          <li><strong>Cookies iklan:</strong> digunakan oleh Google AdSense untuk menampilkan iklan yang relevan.</li>
        </ul>
        <p>Anda dapat menonaktifkan cookies melalui pengaturan browser Anda kapan saja.</p>
      </section>
      <section class="pol-section" id="pihak-ketiga">
        <div class="pol-section-header"><span class="pol-section-num">V</span><h2>Layanan Pihak Ketiga</h2></div>
        <hr class="pol-divider">
        <p>Website ini mengintegrasikan layanan pihak ketiga, antara lain:</p>
        <ul>
          <li><strong>Google AdSense</strong> — menampilkan iklan. Selengkapnya di <a href="https://policies.google.com/privacy" target="_blank" rel="noopener">policies.google.com/privacy</a>.</li>
          <li><strong>Google Fonts</strong> — menampilkan tipografi dari server Google.</li>
          <li><strong>Google Maps</strong> — menampilkan lokasi gereja.</li>
          <li><strong>WhatsApp</strong> — tautan ke nomor kontak sekretariat.</li>
        </ul>
        <div class="pol-highlight"><strong>Perlu diketahui:</strong> Kami tidak memiliki kendali atas data yang dikumpulkan oleh layanan pihak ketiga tersebut.</div>
      </section>
      <section class="pol-section" id="hak-pengguna">
        <div class="pol-section-header"><span class="pol-section-num">VI</span><h2>Hak Pengguna</h2></div>
        <hr class="pol-divider">
        <p>Sesuai prinsip perlindungan data, Anda memiliki hak:</p>
        <ul>
          <li><strong>Hak akses:</strong> meminta informasi data pribadi yang kami miliki tentang Anda.</li>
          <li><strong>Hak koreksi:</strong> meminta perbaikan atas data yang tidak akurat.</li>
          <li><strong>Hak penghapusan:</strong> meminta penghapusan data pribadi Anda.</li>
          <li><strong>Hak pembatasan:</strong> meminta pembatasan penggunaan data dalam kondisi tertentu.</li>
          <li><strong>Hak menolak:</strong> menolak penggunaan data untuk tujuan tertentu.</li>
        </ul>
      </section>
      <section class="pol-section" id="keamanan">
        <div class="pol-section-header"><span class="pol-section-num">VII</span><h2>Keamanan Data</h2></div>
        <hr class="pol-divider">
        <p>Kami menerapkan langkah teknis untuk melindungi data dari akses tidak sah. Website ini menggunakan protokol <strong>HTTPS</strong> untuk mengenkripsi seluruh transmisi data.</p>
        <p>Kami tidak menjual, menyewakan, atau memperdagangkan data pribadi Anda kepada pihak ketiga mana pun untuk kepentingan komersial.</p>
      </section>
      <section class="pol-section" id="kontak">
        <div class="pol-section-header"><span class="pol-section-num">VIII</span><h2>Hubungi Kami</h2></div>
        <hr class="pol-divider">
        <p>Apabila Anda memiliki pertanyaan terkait Kebijakan Privasi ini, silakan menghubungi kami:</p>
        <div class="pol-contact">
          <div class="pol-contact-name">Paroki Santa Maria Dengan Tidak Bernoda Asal Tulungagung</div>
          <div class="pol-contact-row"><span class="icon">📍</span><span>Jl. Ahmad Yani Tim. Gg. IV No.1, Bago, Kec. Tulungagung, Kab. Tulungagung, Jawa Timur 66218</span></div>
          <div class="pol-contact-row"><span class="icon">👤</span><span>Komsos Paroki Tulungagung</span></div>
          <div class="pol-contact-row"><span class="icon">💬</span><a href="https://wa.me/6285183068895" target="_blank" rel="noopener">WhatsApp: 0851-8306-8895</a></div>
          <div class="pol-contact-row"><span class="icon">🕐</span><span>Senin – Selasa, Kamis – Sabtu · 08.00 – 14.00 WIB <em>(Rabu tutup)</em></span></div>
        </div>
      </section>
      <footer class="pol-footer-note">
        Kebijakan Privasi ini dapat diperbarui sewaktu-waktu tanpa pemberitahuan sebelumnya.<br>
