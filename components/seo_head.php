...
if (!defined('SITE_OG_IMAGE')) define('SITE_OG_IMAGE', 'https://img.parokitulungagung.org/assets/og-preview.webp');
if (!defined('SITE_LOGO'))     define('SITE_LOGO',     'https://img.parokitulungagung.org/assets/header-logo-1.webp');
...
// ── Sanitasi ───────────────────────────────────────────────────────────
if (!function_exists('_seo_e')) {
    function _seo_e($s): string {
...
// 🔥 paksa OG ke Cloudflare R2 bucket parokitulungagung/ogpreview/ + JPG
$_ogCdnBase = defined('R2_CDN_URL') ? rtrim(R2_CDN_URL, '/') : 'https://img.parokitulungagung.org';
$_finalImg  = $_ogCdnBase . '/ogpreview/' . $_imgBase . '.jpg';
...
<meta name="twitter:image" content="<?= $sImg ?>">
  ...
  <!-- Resource Hints (Cloudflare CDN & Fonts) -->
  <link rel="preconnect" href="https://img.parokitulungagung.org" crossorigin>
  <link rel="dns-prefetch" href="https://img.parokitulungagung.org">
  ...
  <link rel="apple-touch-icon" href="https://img.parokitulungagung.org/assets/apple-touch-icon.webp">
...
/* ── Cegah Google Auto Ads menyisipkan iklan otomatis DI DALAM konten ──
   (supaya tata letak halaman tidak rusak). Iklan yang tetap boleh tampil
   hanyalah unit iklan yang kita pasang manual (mis. di artikel & sidebar),
   serta format overlay (anchor/vignette) yang tidak mengganggu tata letak. */
body { google-auto-ads: ignore; }
  </style>
