<?php
/**
 * admin/dashboard.php — ringkasan cepat + link ke Sistem → Cache
 */
...
// ── Hitung info cache (ringkasan semua grup, lihat CacheRegistry.php) ───
$cache       = getCacheOverallSummary();
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px">
    <div>
      ...
      <div style="font-size:12.5px;color:var(--text-secondary)">
        <span style="color:var(--success);font-weight:600"><?= $cacheCount ?> file aktif</span>
        &nbsp;·&nbsp; <?= $cacheSizeKB ?> KB &nbsp;·&nbsp; tersebar di beberapa folder cache
      </div>
    ...
    <?php if ($isSuperadmin): ?>
    <a href="/admin/pages/cache.php" class="btn btn-secondary btn-sm" style="white-space:nowrap">
