    ...
    if (!$identifier) {
        ...
        try {
            ...
            if ($user && !empty($user['email'])) {
                ...
                // Kirim email
                // Deteksi HTTPS yang benar di balik Cloudflare proxy:
                // Cloudflare meneruskan header CF-Visitor: {"scheme":"https"}
                // atau X-Forwarded-Proto: https — periksa keduanya.
