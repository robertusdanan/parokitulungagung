  ...
  tbody.innerHTML = data.map(row => {
    ...
    const namaHtml = foto
      ? `<div style="display:flex;align-items:center;gap:8px">
           <img src="${escHtml(window.PERSON_CDN_URL+'/'+foto)}" alt="" style="width:32px;height:32px;border-radius:50%;object-fit:cover;border:2px solid var(--border)" onerror="this.style.display='none'">
...
function openEditModal(rowNum) {
  ...
  if (row['Foto']) { prev.src=window.PERSON_CDN_URL+'/'+row['Foto']; prev.style.display='block'; plac.style.display='none'; }
