...
function setThumb(url, filename, alt, ogUrl, orientation, presetKey, presetLabel, dimW, dimH) {
  ...
  const cdnUrl = toCdnArticleUrl(url);

  document.getElementById('fieldThumbnail').value     = cdnUrl;
...
function openPreview() {
  ...
  const html = `
    <div class="preview-article">
      ...
      ${thumbnail
        ? `<img src="${toCdnArticleUrl(thumbnail)}" alt="${_esc(thumbAlt)}" class="preview-thumbnail">`
