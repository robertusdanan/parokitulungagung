...
function waitElement(id, callback) {
  ...
  function _renderGrid(files) {
    ...
    if (!files.length) {
      grid.innerHTML = '<div class="aip-empty" style="grid-column:1/-1"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" width="40" height="40"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg><p>Belum ada gambar artikel di Cloudflare R2</p></div>';
      return;
    }
