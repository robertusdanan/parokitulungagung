...
body {
  ...
  font-family: "Milky Juice", cursive;
  font-weight: normal; /* atau 400/500 tergantung hasil yang kamu inginkan */
}
    ...
    <div class="flex flex-wrap border-b border-black text-[11px] leading-tight">
      ...
      <div class="flex items-center border-r border-black w-full sm:w-1/2 px-2 py-1 gap-4">
        ...
        <img
          ...
          src="/pages/komedi/icon_komedi.png"
        ...
        <div class="flex flex-col text-[11px] leading-tight">
          ...
          <div class="flex items-center gap-1">
            ...
            <span>komedi@parokitulungagung.org</span>
...
<div class="grid grid-cols-3 text-[13px] font-semibold mb-2">
  ...
  <div class="text-center">
    <input type="text" id="totalAmount" readonly class="border-b border-black w-full text-center bg-gray-100 handwritten cursor-not-allowed" />
  </div>
</div>
...
<div class="grid grid-cols-3 text-[13px] font-semibold mb-2">
  ...
  <div class="text-center">
    <input type="text" id="downPayment" oninput="handleDPInput()" class="border-b border-black w-full handwritten text-center" />
  </div>
</div>
...
<div class="grid grid-cols-3 text-[13px] font-semibold">
  ...
  <div class="text-center font-semibold">
    <input type="text" id="remaining" readonly class="border-b border-black w-full text-center bg-gray-100 handwritten cursor-not-allowed" />
  </div>
</div>
