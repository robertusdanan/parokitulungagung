    ...
    <div class="klp-hero<?= $banner ? ' has-banner' : '' ?>">
      ...
      <div class="klp-hero-content">
        ...
        <img src="<?= e($icon) ?>" alt="<?= e($nama) ?>" class="klp-hero-icon"
             width="72" height="72" loading="lazy" decoding="async" onerror="this.style.display='none'">
        <?php else: ?>
            ...
            <div class="klp-pengurus-item">
              <div class="klp-pengurus-avatar">
                ...
                <img src="<?= e($p['foto']) ?>" alt="<?= e($pNama) ?>"
                     width="80" height="80" loading="lazy" decoding="async" onerror="this.style.display='none';this.nextSibling.style.display='flex'">
        ...
        <div class="klp-sidebar-card">
          ...
          <div style="padding:.6rem .8rem">
            ...
            <a href="/kategorial/<?= e($s) ?>"
              ...
              <?php if ($kmIcon): ?>
              <img src="<?= e($kmIcon) ?>" alt="" width="20" height="20" loading="lazy" decoding="async"
