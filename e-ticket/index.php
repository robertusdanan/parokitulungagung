...
// Total kuota yang benar-benar dibuka ke publik (mengikuti open_quota tiap
// kategori), dipakai sebagai nilai awal "Tiket Tersedia" di hero section
// agar konsisten dengan perhitungan di js/main.js (bukan TOTAL_QUOTA statis).
$totalOpenQuota = 0;
foreach ($seatStatus as $s) {
    $totalOpenQuota += (int)($s['open_quota'] ?? 0);
}
    ...
    <div class="hero-section">
        ...
        <div class="hero-content">
            ...
            <div class="hero-stats">
                ...
                <div class="stat-item">
                    <div class="stat-value" id="totalAvailable"><?= $totalOpenQuota ?></div>
