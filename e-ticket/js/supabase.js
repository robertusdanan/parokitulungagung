...
const SB = (() => {
    ...
    async function getAllTickets() {
        const res = await fetch(
            `${REST}/ticketing?select=id,ticket_number,name,phone,ticket_type,primary_ticket_type,seat_numbers,total_seats,price,status,seat_selection_status,image_url,qr_data,order_date,created_at,wa_clicked,wa_clicked_at,wa_sent,wa_sent_at&order=created_at.desc&limit=1500`,
            { headers: headers() }
        );
