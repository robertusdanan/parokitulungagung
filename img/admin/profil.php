...
<div class="profil-layout">
  ...
  <div class="avatar-card">
    ...
    <div style="margin-top:16px;padding-top:16px;border-top:1px solid var(--border);font-size:11.5px;color:var(--text-muted);line-height:1.7;text-align:left">
      ...
      • Maks 2MB<br>
      • Otomatis dipotong jadi kotak 200×200px<br>
      ...
      <div class="profil-section-body">
        ...
        <div class="form-grid">
          ...
          <div class="form-group">
            ...
            <small style="color:var(--text-muted);font-size:11px">Digunakan untuk login. Huruf, angka, underscore (3–32 karakter)</small>
          </div>
          <div class="form-group">
            <label>Email</label>
