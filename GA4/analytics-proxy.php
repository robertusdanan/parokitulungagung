...
// CACHE
// ═════════════════════════════════════════════════════════════════════
// Dipusatkan di /cache/analytics/ (sejajar dengan cache/supabase,
// cache/runtime, dll) — bukan lagi folder terpisah di GA4/cache/,
// supaya semua cache situs bisa dikelola dari satu tempat (lihat
// admin/includes/CacheRegistry.php & halaman admin Sistem → Cache).
$cacheDir = rtrim($_SERVER['DOCUMENT_ROOT'] ?? dirname(__DIR__), '/') . '/cache/analytics/';
